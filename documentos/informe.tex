...
\begin{figure}[!ht]
    \centering
    \begin{floatrow}
      \ffigbox[\FBwidth]{\caption{Comparación C sin optimización de Cropflip}}{%
        \includegraphics[scale=.5]{./imagenes/implementacionesC-CropflipSinO3.jpeg}
      }
    \end{floatrow}
\end{figure}
...
\begin{figure}[!ht]
    ...
    \begin{floatrow}
      \ffigbox[\FBwidth]{\caption{Comparación C vs ASM con optimización entre CropflipCv1, CropflipCv2 y CropflipASM}}{%
        \includegraphics[scale=.5]{./imagenes/implementacionesCASM-cropflipConO3.jpeg}
      }
    \end{floatrow}
\end{figure}
...
\begin{figure}[!ht]
    ...
    \begin{floatrow}
      \ffigbox[\FBwidth]{\caption{Comparación ASM}}{%
        \includegraphics[scale=.5]{./imagenes/implementacionesASM-Sepia.jpeg}
      }
    \end{floatrow}
\end{figure}
