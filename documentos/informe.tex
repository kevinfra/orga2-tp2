...
\begin{figure}[!ht]
    ...
    \begin{floatrow}
      \ffigbox[\FBwidth]{\caption{Comparación C con optimización O3 y AVX vs ASM}}{%
        \includegraphics[scale=.39]{./imagenes/cropflip-asmVScO3AVX.jpeg}
      }
    \end{floatrow}
\end{figure}
...
\makebox[\linewidth]{%        to center the image
  \includegraphics[keepaspectratio=true,scale=0.4]{./imagenes/sepia-asmVSc.jpeg}}
...
\begin{minipage}{\linewidth}% to keep image and caption on one page
\makebox[\linewidth]{%        to center the image
  \includegraphics[keepaspectratio=true,scale=0.4]{./imagenes/sepia-asmVScO3.jpeg}}
...
\begin{minipage}{\linewidth}% to keep image and caption on one page
\makebox[\linewidth]{%        to center the image
  \includegraphics[keepaspectratio=true,scale=0.4]{./imagenes/sepia-asmVScO3SSE4-2AVX.jpeg}}
