...
IMAGENES=["bastachicos.bmp"]

assure_dirs()

sizes=['128x128', '256x256', '348x348','200x200', '204x204', '208x208', '512x512', '640x640', '768x768', '869x896', '1024x1024', '1152x1152', '1024x768', '1280x1280', '1408x1408', '1536x1536', '1664x1664']
