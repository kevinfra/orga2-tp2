...
canalRojo: dd 5, 0, 0, 0
canalVerde: dd 3, 0, 0, 0
canalAzul: dd 2, 0, 0, 0
divDiez: dd 10, 0, 0, 0
	...
	.forFilas:
		...
		.forCols:
			...
			.cargar4pixelsEnXmm1:
				...
				divps xmm7, xmm10 ;p3r
				divps xmm8, xmm10	;p3g
				divps xmm9, xmm10	;p3b
				
				pxor xmm6, xmm6
				punpcklwd xmm6, xmm2 ;tengo en la ultima dword de xmm6 a p3a
				psrldq xmm6, 12d ;tengo en la dword mas baja de xmm6 a p3a
				cvtdq2ps xmm3, xmm6
				...
				cvtdq2ps xmm9, xmm3
					;ahora divido xmm7,8,9 por 10 para que sea equivalente a multiplicar directamente por 0.5, 0.3 y 0.2
				divps xmm7, xmm10 ;p2r
				divps xmm8, xmm10	;p2g
				divps xmm9, xmm10	;p2b
				
				punpckhwd xmm6, xmm2 ;tengo en la ultima dword de xmm7 a p2a
				psrld xmm6, 12d;tengo en la dword mas baja de xmm6 a p2a
				cvtdq2ps xmm3, xmm6
				...
				cvtdq2ps xmm9, xmm3
					;ahora divido xmm7,8,9 por 10 para que sea equivalente a multiplicar directamente por 0.5, 0.3 y 0.2
				divps xmm7, xmm10 ;p1r
				divps xmm8, xmm10	;p1g
				divps xmm9, xmm10	;p1b
				...
				cvtdq2ps xmm9, xmm3
					;ahora divido xmm7,8,9 por 10 para que sea equivalente a multiplicar directamente por 0.5, 0.3 y 0.2
				divps xmm7, xmm10 ;p0r
				divps xmm8, xmm10	;p0g
				divps xmm9, xmm10	;p0b
